            ...
            <div class="row ">
                ...
                <div class="col-md">
                    <div class="card" style="width: 265px ;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">Kit Cachos dos Sonhos</h5>
                            <p class="card-text">Marca: L'oréal
                                <br>Produtos para cabelo
                                <br>Faixa etária: +14
                                <br>
                                <R1><strong>R$ 58,99</strong></R1>
                            </p>
                ...
                <div class="col-md">
                    <div class="card" style="width: 265px ;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">Kit Limpeza de Pele</h5>
                            <p class="card-text">Marca: L'oréal
                                <br>Produtos para pele
                                <br>Faixa etária: +14
                                <br>
                                <R1><strong>R$ 140,41</strong></R1>
                            </p>
                            <button type="button" style="width: 225px ;" class="btn btn-outline-success">COMPRAR <img src="img/menu/carrinhoPreto.png" width="20" height="20"></button>
                        </div>
                    </div>
                ...
                <div class="col-md">
                    <div class="card" style="width: 265px ;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">Kit Cabelos Cacheados</h5>
                            <p class="card-text">Marca: L'oréal
                                <br>Produtos para cabelo
                                <br>Faixa etária: +14
                                <br>
                                <R1><strong>R$ 102,05</strong></R1>
                            </p>
                            <button type="button" style="width: 225px ;" class="btn btn-outline-success">COMPRAR <img src="img/menu/carrinhoPreto.png" width="20" height="20"></button>
                        </div>
                    </div>
